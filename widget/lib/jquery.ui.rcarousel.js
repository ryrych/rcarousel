(function ($) {
	$.widget("ui.rcarousel", {
		_create: function() {
			...
			// create rcarousel-wrapper inside root element; this is needed for animating
			$root
				.addClass( "ui-carousel" )
				.children()
				.wrapAll( "<div class='rcarousel-wrapper'></div>" );
		...
		_addElement: function( jQueryElement, direction ) {
			var $root = $( this.element ),
				$content = $root.find( "div.rcarousel-wrapper" ),
				options = this.options;
		...
		_saveElements: function() {
			var $el,
				$root = $( this.element ),
				$elements = $root.find( "div.rcarousel-wrapper" ).children(),
				data = $root.data( "data" );
